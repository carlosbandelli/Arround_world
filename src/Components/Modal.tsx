...
export function Modal({
  ...
  const defaultClassName1 =
    'mr-4 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600';
  const defaultClassName2 =
    'mr-4 px-4 py-2 bg-indigo-800 text-white rounded hover:animate-pulse-slow';
      ...
      <div className="bg-white p-8 rounded-lg">
        ...
        <div className={divButton || defaultClassDivButton}>
          <Button
            type={'button'}
            text={textButton1 || ''}
            className={className1 || defaultClassName1}
            iconClassName={iconClass1}
          ...
          <Button
            type={'button'}
            text={textButton2 || ''}
            className={className2 || defaultClassName2}
            iconClassName={iconClass2}

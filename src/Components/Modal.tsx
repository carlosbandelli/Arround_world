...
export function Modal({ title, body, onCancel, onConfirm, textButton1, textButton2, className1, className2, iconName1, iconName2, iconSize1, iconSize2, iconColor1, iconColor2, iconClass1, iconClass2, divButton, isOpen}: ModalProps) {
